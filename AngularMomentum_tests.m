...
declareQNHalfInteger[{a,\[Alpha],\[Alpha]p,b,\[Beta],\[Beta]p,c,\[Gamma],d,mt[a],mt[b],mt[c],mtp[a],mtp[b],mtp[c],t[a,b,c],mt[a,b,c],tp[a,b,c],mtp[a,b,c]}];
declareQNInteger[{m,\[Mu],mp,\[Mu]p,u,up,t,tp,t[a,b],mt[a,b],tp[a,b],mtp[a,b]}];
